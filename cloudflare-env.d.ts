/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: c4044945250a23897df510f71a379d58)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DIAGNOSTIC_EMAIL: SendEmail;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_CLARITY_ID" | "NEXT_PUBLIC_GA_ID" | "NEXT_PUBLIC_TURNSTILE_SITEKEY" | "TURNSTILE_SECRET" | "TURNSTILE_HOSTNAMES">> {}
}
