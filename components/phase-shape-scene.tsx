...
// Geometrías, materiales, luces y velocidades recuperados del original 2b9eaa6.
...
export function PhaseShapeScene({ kind, active }: Props) {
  return (
    <Canvas
    ...
    >
      ...
      <Suspense fallback={null}><RotatingShape kind={kind} /></Suspense>
    </Canvas>
  );
}
